...
/**
 * Взято отсюда: https://gist.github.com/ankushg/8c0c3144318b1c17abb228d6211ba996
 *
 *
    ...
    companion object {
        ...
        fun OkHttpClient.Builder.enableTls12() = apply {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP_MR1) {
                try {
                    val sslContext = SSLContext.getInstance(TlsVersion.TLS_1_2.javaName()) // для старой версии okhttp3
//                    val sslContext = SSLContext.getInstance(TlsVersion.TLS_1_2.javaName)
    ...
    private fun Socket.patchForTls12(): Socket {
        return (this as? SSLSocket)?.apply {
            enabledProtocols += TlsVersion.TLS_1_2.javaName() // для старой версии okhttp3
